...
# load("G:/My Drive/00 UW/02 Classes/Evolutionary Ecology of Marine Mammals/2026 FISH 470 Evolutionary Ecology of Marine Mammals/In class slides/Week 5/Lab/eDNA_MM_detections.Rdata")
# 
...
#                         TRUE~sp)) %>%
#   unite(genus, sp, col = "Species", sep = " ") %>%
#   group_by(NWFSCsampleID, Species) %>%
...
#   select(-nReads) %>% 
#   ungroup() %>% 
#   pivot_wider(names_from = Species, values_from = prey_prop) 
# 
...
detect_data <- read_csv("G:/My Drive/00 UW/02 Classes/Evolutionary Ecology of Marine Mammals/2026 FISH 470 Evolutionary Ecology of Marine Mammals/In class slides/Week 5/Lab/eDNA_MM_detections.csv")
...
detect_data_fish <- read_csv("G:/My Drive/00 UW/02 Classes/Evolutionary Ecology of Marine Mammals/2026 FISH 470 Evolutionary Ecology of Marine Mammals/In class slides/Week 5/Lab/eDNA_MM_fish_detections.csv")
...
ggplot(detect_data_humpy, aes(x = prey_species, y = prey_prop)) +
...
ggplot(detect_data_lags, aes(x = prey_species, y = prey_prop)) +
  geom_boxplot(aes(fill = prey_species)) +
  theme(legend.position = "none") +
  facet_wrap(~Detected) +
...
save(detect_data_fish, file = "G:/My Drive/00 UW/02 Classes/Evolutionary Ecology of Marine Mammals/2026 FISH 470 Evolutionary Ecology of Marine Mammals/In class slides/Week 5/Lab/")
